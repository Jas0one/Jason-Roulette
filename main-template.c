...
int main()
{
    ...
    const char *titleText = "Jason's Roulette?";
    ...
    int bulletPosition = rand() % 6; // Random bullet position
    ...
    while (!WindowShouldClose())
    {
        ...
        else if (!gameStarted)
        {
            ...
            DrawTextEx(customFont, "Press SPACE to start the game", (Vector2){ screenWidth / 2 - textStartWidth / 2, screenHeight / 2 - 10 }, 20, 1, BLACK);
